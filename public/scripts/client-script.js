...
window.addEventListener('load', ()=> {
	...
	if (getCookie('nickName') != null) {
		document.querySelector('#rubrik').textContent='Kölista - ' + decodeURIComponent(getCookie('nickName'));
	}
	else if(getCookie('nickName2') != null) {
		document.querySelector('#rubrik').textContent='Kölista - ' + decodeURIComponent(getCookie('nickName2'));
	}
